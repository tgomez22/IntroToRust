...
fn main() {
    ...
    match args.len().cmp(&4) {
        ...
        Ordering::Equal => {
            ...
            let converted_args: [u64; 3] =
                [parsenum(&args[1]), parsenum(&args[2]), parsenum(&args[3])];
...
#[test]
fn test_modexp_valid_input_4() {
    assert_eq!(4, modexp(10, 9, 6));
}

#[test]
fn test_modexp_valid_input_5() {
    assert_eq!(34, modexp(450, 768, 517));
}

#[test]
fn test_modexp_valid_input_6() {
    assert_eq!(16, modexp(2, 20, 17));
}

#[test]
fn test_modexp_valid_input_7() {
    let num = u64::max_value();
    assert_eq!(166, modexp(num, num, 517));
}

#[test]
fn test_modexp_valid_input_8() {
    let num = u64::max_value();
